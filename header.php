    ...
    <nav class="header__nav js-header__nav" id="header-nav" role="navigation" aria-label="Main">
      <div class="header__nav-inner">
        ...
        <ul class="header__list">
          ...
          <li class="header__item"><a href="#0" class="header__link">EMPRESA</a></li>
          <li class="header__item"><a href="#0" class="header__link">CONTATO</a></li>
          <li class="header__item"><a href="#0" class="header__nav-btn btn btn--primary">ESTOQUE</a></li>
