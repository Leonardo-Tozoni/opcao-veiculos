  ...
  <a id="link-whatsapp" href="https://api.whatsapp.com/send?l=pt&amp;phone=555433162226" target="_blank"><img src="<?php echo midiaSrc('whats-logo.svg'); ?>" style="height:64px; position:fixed; bottom: 25px; right: 25px; z-index:99999;" data-selector="img"></a>
...
<script>
$('.scroll-to-secao-2').click(function(event) {
...
<script>
$('.scroll-to-secao-3').click(function(event) {
  event.preventDefault();
  var target = $(this.hash);
  $('html, body').animate({
    scrollTop: target.offset().top
...
<script>
$('.scroll-to-secao-4').click(function(event) {
  event.preventDefault();
  var target = $(this.hash);
  $('html, body').animate({
    scrollTop: target.offset().top
...
<script>
$('.scroll-to-secao-5').click(function(event) {
  event.preventDefault();
  var target = $(this.hash);
  $('html, body').animate({
    scrollTop: target.offset().top
